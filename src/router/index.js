...
},
{
  ...
  name: '记账管理系统',
  icon: 'setting',
  authority: 'recordManager',
  children: [
    {
      path: 'orderManager',
      icon: '',
      component: _import('record/order/index'),
      name: '消费记录',
      authority: 'orderManager'
    }, {
      path: 'tradeTypeManager',
      icon: '',
      component: _import('record/tradetype/index'),
      name: '消费类型',
      authority: 'tradeTypeManager'
    },
    {
      path: 'studyManager',
      icon: '',
      component: _import('record/study/index'),
      name: '学习记录',
      authority: 'studyManager'
    },
    {
      path: 'menstruationManager',
      icon: '',
      component: _import('record/menstruation/index'),
      name: '经期记录',
      authority: 'menstruationManager'
    }]
}
