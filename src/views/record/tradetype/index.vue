...
<div class="app-container calendar-list-container">
  <div class="filter-container">
    <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="类型名称" v-model="listQuery.typeName"> </el-input>
  ...
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    ...
    <el-table-column width="200" align="center" label="类型名称"> <template scope="scope">
...
export default {
  ...
  created() {
    this.getList();
    this.deptManager_btn_edit = this.elements['tradeTypeManager:btn_edit'];
    this.deptManager_btn_del = this.elements['tradeTypeManager:btn_del'];
    this.deptManager_btn_add = this.elements['tradeTypeManager:btn_add'];
  },
  computed: {
    ...mapGetters([
      'elements'
