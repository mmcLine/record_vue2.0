...
<div class="app-container calendar-list-container">
  ...
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
   ...
   <el-table-column width="110" align="center" label="权限类型"> <template scope="scope">
            <span>{{getPowerName(scope.row.powerGroup)}}</span>
          </template> </el-table-column>
   <el-table-column width="110" align="center" label="部门"> <template scope="scope">
    ...
    <el-form :model="form" :rules="rules" ref="form" label-width="100px">
      ...
      <el-form-item v-if="dialogStatus == 'create'" label="密码" placeholder="请输入密码" prop="password">
       ...
       <el-form-item label="部门">
        <el-select class="filter-item" v-model="form.deptId" placeholder="请选择">
          <el-option v-for="item in  deptOptions" :key="item.id" :label="item.deptName" :value="item.id"> </el-option>
        </el-select>
      </el-form-item>
       <el-form-item label="权限类型">
        <el-select class="filter-item" v-model="form.powerGroup" placeholder="请选择">
          <el-option v-for="item in  powerOptions" :key="item.id" :label="item.name" :value="item.id"> </el-option>
        </el-select>
      </el-form-item>
